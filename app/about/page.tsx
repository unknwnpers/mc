    ...
    <div className="min-h-screen bg-[#FCF9F7] selection:bg-blush/20">
      ...
      <main className="max-w-[1440px] mx-auto px-6 md:px-10 py-32 md:py-40">
        ...
        <div className="relative text-center mb-24 md:mb-32">
          ...
          <p className="text-[13px] font-black text-blush uppercase tracking-[0.3em] mb-4 relative z-10">Our Essence</p>
        ...
        <div className="grid lg:grid-cols-2 gap-16 md:gap-24 items-center mb-32 md:mb-48">
          ...
          <div className="relative">
            <div className="absolute -inset-6 bg-cream/40 rounded-[60px] -rotate-3 blur-2xl" />
            <div className="relative group overflow-hidden rounded-[50px] shadow-2xl shadow-charcoal/5 border border-[#F3E8E5]">
              <Image
            ...
            <div className="absolute -bottom-8 -right-8 bg-white p-6 rounded-[32px] shadow-xl border border-[#F3E8E5] hidden md:block animate-bounce-slow">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-lg font-serif font-bold text-charcoal leading-none">Kochi, Kerala</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-10">
            <div>
              <p className="text-[11px] font-black text-blush uppercase tracking-[0.3em] mb-3">Our Heritage</p>
              <h2 className="text-4xl md:text-5xl font-serif font-bold text-charcoal tracking-tight leading-[1.1]">
                A Journey of <br />
                <span className="text-blush italic">Pure Comfort</span>
              </h2>
            </div>
            ...
            <div className="space-y-6 text-neutral-600 leading-relaxed text-lg font-sans">
              ...
              <div className="p-8 bg-white rounded-[40px] border border-[#F3E8E5] shadow-sm relative overflow-hidden group">
                <div className="absolute top-0 right-0 p-4 opacity-[0.03] group-hover:opacity-[0.07] transition-opacity">
                  <Sparkles className="w-24 h-24 text-charcoal" />
                </div>
                <p className="font-bold text-charcoal relative z-10">
        ...
        <div className="mb-32 md:mb-48">
          <div className="text-center mb-16 md:mb-20">
            <p className="text-[11px] font-black text-blush uppercase tracking-[0.3em] mb-3">Why Us</p>
            <h2 className="text-4xl md:text-5xl font-serif font-bold text-charcoal tracking-tight">
              Our <span className="text-blush italic">Core Values</span>
            </h2>
          </div>
        ...
        {/* CTA SECTION */}
        <div className="relative overflow-hidden bg-charcoal rounded-[60px] p-12 md:p-24 text-center shadow-2xl shadow-charcoal/20">
          <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-blush opacity-10 blur-[150px] -translate-y-1/2 translate-x-1/2" />
          ...
          <div className="relative z-10 max-w-4xl mx-auto">
            <p className="text-[11px] font-black text-blush uppercase tracking-[0.4em] mb-6">Experience it yourself</p>
            <h2 className="text-4xl md:text-6xl font-serif font-bold text-white mb-8 tracking-tight">
              Join the <span className="text-blush italic">Experience</span>
            </h2>
            ...
            <div className="flex flex-wrap justify-center gap-6">
              <a
                href="/contact"
                className="inline-flex items-center gap-4 bg-blush text-white px-10 py-5 rounded-[24px] hover:bg-rose-400 transition-all duration-500 font-black uppercase tracking-widest text-xs shadow-xl shadow-blush/20 transform hover:-translate-y-1 active:scale-95"
              >
              ...
              <a
                href="/products"
                className="inline-flex items-center gap-4 bg-white/5 text-white px-10 py-5 rounded-[24px] hover:bg-white hover:text-charcoal transition-all duration-500 font-black uppercase tracking-widest text-xs border border-white/10 transform hover:-translate-y-1 active:scale-95"
              >
