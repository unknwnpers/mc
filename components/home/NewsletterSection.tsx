      ...
      <div className="max-w-[1320px] mx-auto px-4 md:px-6">
        ...
        >
          ...
          <div className="relative z-20 text-center max-w-[760px] mx-auto">
            ...
            {/* Description */}
            <p className="text-[15px] md:text-[18px] leading-[1.9] text-[#5C5C5C] mt-6 md:mt-8 max-w-[620px] mx-auto">
              ...
              {subscribed ? (
                ...
                >
                  ...
                  <div className="text-left">
                    <p className="text-[18px] font-bold text-[#1E1E1E]">You&apos;re in!</p>
                    <p className="text-[15px] text-[#5C5C5C]">Welcome to the Miks & Chiks family.</p>
                  </div>
                </motion.div>
              ) : (
            ...
            {!subscribed && (
              ...
              >
                ...
                <p className="text-[14px] font-medium text-[#7A7A7A]">
                  Join <span className="font-bold text-[#5C5C5C]">12,000+</span> moms already subscribed
                </p>
              </motion.div>
            )}
