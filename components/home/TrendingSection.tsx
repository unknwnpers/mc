        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1.1fr_1fr] gap-4 md:gap-6 lg:gap-8 items-stretch">
          ...
          >
            ...
            >
              ...
              {/* NEW badge */}
              <div className="absolute top-6 left-6 bg-[#E9897E] text-white text-[12px] font-bold px-4 py-1.5 rounded-full shadow-[0_4px_12px_rgba(233,137,126,0.3)]">
                NEW
              </div>
...
function MiniProductCard({ product }: { product: Product }) {
  ...
  return (
    <Link
      ...
      className="group bg-white rounded-[28px] overflow-hidden flex flex-col h-full border border-[rgba(233,137,126,0.06)] hover:-translate-y-1.5 transition-all duration-300 ease-out"
      style={{ boxShadow: '0 14px 35px rgba(0,0,0,0.04)' }}
      onMouseEnter={(e) => { (e.currentTarget as HTMLElement).style.boxShadow = '0 20px 48px rgba(233,137,126,0.10)'; }}
    ...
    >
      ...
      <div className="relative overflow-hidden aspect-[4/5] bg-[#F8F1EC]">
        ...
        />
        {/* NEW badge */}
        <div className="absolute top-3 left-3 bg-[#E9897E] text-white text-[11px] font-bold px-3 py-1 rounded-full">
          NEW
        </div>
        ...
        <div className="absolute bottom-3 left-3 right-3 translate-y-12 group-hover:translate-y-0 opacity-0 group-hover:opacity-100 transition-all duration-300 hidden md:block">
          <div className="bg-[#E9897E] text-white h-[40px] rounded-full flex items-center justify-center gap-2 text-[13px] font-semibold shadow-[0_6px_20px_rgba(233,137,126,0.3)]">
      ...
      <div className="p-4 md:p-5 flex flex-col flex-1">
        <p className="text-[11px] font-bold tracking-[0.08em] uppercase text-[#E9897E] mb-1">
        ...
        <div className="flex items-baseline gap-2 mt-3 pt-3 border-t border-[rgba(233,137,126,0.06)]">
